"""
ClassClassMTL Initialization Script (Part 1) - Source Version

This model is for: Both single-cell and patient data have classification labels

Model Type: ClassClass MTL
- Class (SC): Single-cell data with classification labels
- Class (Pat): Bulk data with classification labels
...
# Load patient expression data and labels
